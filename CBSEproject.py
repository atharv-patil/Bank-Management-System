...
mycon=ship.connect(user = 'root', passwd='1111', host='localhost', database= 'project')
...
def Insert():
    while True:
        ...
        Rec=[Acc,Name.upper(),Mob,EmailID.upper(),Address.upper(),City.upper(),Country.upper(),Bal]
